...
// otherwise compiler gives trouble with LIGHTING_COORDS macro (in LineStandardCore.cginc)
	...
	out float4 opos : SV_POSITION)
{
	TRANSFER_SHADOW_CASTER_NOPOS(o,opos)
		...
		o.tex.zw = TRANSFORM_TEX(v.uv1, _MainTex);
	#endif
}
...
{
	#if defined(UNITY_STANDARD_USE_SHADOW_UVS)
		half alpha = tex2D(_MainTex, i.tex.xy / i.tex.zw).a * _Color.a;
